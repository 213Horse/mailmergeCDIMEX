# Create a ready-to-run mail merge kit:
# - /mnt/data/mail_merge.py  (the script)
# - /mnt/data/recipients.xlsx (sample recipient list)
# - /mnt/data/template.html  (sample HTML email template)
#
# You can download, edit, and run these locally.
...
# 1) Sample recipients.xlsx
df = pd.DataFrame(
    [
        {
            "Email": "trinhbaophuong1502@gmail.com",
            "Ten": "Bảo Phương",
            "FilePDF": str(base / "Trần Nguyễn Thanh Ngân - 7.7" / "SK_ScoreReport_51944570_Trần Nguyễn Thanh Ngân.pdf"),
            "Subject": "Kết quả bài thi Versant Professional English Test LV1 -  {{Ten}}",
            "CC": "",
            "BCC": "",
        },
        {
            "Email": "minhquando43730@gmail.com",
            "Ten": "Minh Quân",
            "FilePDF": str(base / "Võ Thị Thanh Lam - 24.7" / "SK_ScoreReport_34847101_Võ Thị Thanh Lam.pdf"),
            "Subject": "Kết quả bài thi Versant Professional English Test LV1 -  {{Ten}}",
            "CC": "",
            "BCC": "",
        },
...
recipients_path = base / "recipients.xlsx"
df.to_excel(recipients_path, index=False)
...
html_template = dedent(
    ...
    <html>
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #111;">
        ...
        <p>Bạn vui lòng cho shop xin tên người nhận, số điện thoại và địa chỉ nhận chứng chỉ nhé.</p>
        <p>Bookmedi cảm ơn bạn</p>
        <p>Best Regards!</p>
        ...
        <p>
          ...
          <a href="https://www.cdimex.com.vn">www.cdimex.com.vn</a>
          | <a href="https://www.bookmedi.vn">www.bookmedi.vn</a>
          | <a href="https://www.ebookmedi.vn">www.ebookmedi.vn</a>
        </p>
      </body>
    </html>
    """
...
script_path = base / "send_mail_merge.py"
script_path.write_text(script, encoding="utf-8")

# Provide paths for the user
print("Created files:")
print(f"- {recipients_path}")
